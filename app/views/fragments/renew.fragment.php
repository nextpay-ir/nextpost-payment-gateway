                                ...
                                <div class="row clearfix">
                                    <div class="options">
                                            ...
                                            <div class="clearfix">
                                                <div class="option-group-item">
                                                    <label>
                                                        <input class="custom-radio" name="plan"
                                                               data-amount="<?= round($SelectedPackage->get("monthly_price"), 2) * 100 ?>"
                                                               data-desc="<?= htmlchars($SelectedPackage->get("title"))." - ".__("Monthly Plan") ?>"
                                                               type="radio" value="monthly" checked>
                                                        <div>
                                                            <div>
                                                                <div class="price">
                                                                    <span class="number"><?= format_price($SelectedPackage->get("monthly_price")) ?></span>
                                                ...
                                                <div class="option-group-item">
                                                    <label>
                                                        ...
                                                        ?>
                                                        <input class="custom-radio" name="plan"
                                                               data-amount="<?= round($annual_price, 2) * 100 ?>"
                                                               data-desc="<?= htmlchars($SelectedPackage->get("title"))." - ".__("Annual Plan") ?>"
                                                               type="radio" value="annual">
                                                        <div>
                                                            <div>
                                                                <div class="price">
                                                                    <span class="number"><?= format_price($annual_price) ?></span>
                                                                    <?= $Settings->get("data.currency") ?>
                                                                </div>
                                        ...
                                        <div class="option-group none payment-gateways" style="margin-bottom:45px">
                                            ...
                                            <div class="clearfix">
                                                <?php if ($Integrations->get("data.stripe.publishable_key") && $Integrations->get("data.stripe.publishable_key")): ?>
                                                    <div class="option-group-item">
                                                        <label>
                                                ...
                                                <?php if ($Integrations->get("data.nextpay.api_key")): ?>
                                                    <div class="option-group-item">
                                                        <label>
                                                            <input class="custom-radio" name="payment-gateway" type="radio" value="nextpay">
                                                            <div>
                                                                <div class="text-c">
                                                                    <img src="<?= APPURL."/assets/img/cc/paypal.svg" ?>" alt="Visa">
                                                                </div>
